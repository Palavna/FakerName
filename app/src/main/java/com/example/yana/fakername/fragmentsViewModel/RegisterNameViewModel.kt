...
class RegisterNameViewModel(private val authRepos: AuthRepository, private val profRepos: ProfileCabinetRepository): ViewModel() {
    ...
    fun register(name: String, email: String, password: String){
        viewModelScope.launch(Dispatchers.IO) {
            runCatching {
                val result = authRepos.register(name = name, login = email, password = password)
